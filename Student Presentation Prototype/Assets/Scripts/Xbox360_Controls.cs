...
{
	string[,] gamepad = new string[10,6] {
	...
	void UserInputs()
	{
		if(playerAnimator)
		{
			...
			{				
				//Debug.Log("A" + (playerController - 1) + " Button!");
			}

			if(Input.GetButton(gamepad[playerController, 5]))//gets the B button
			{
				//Debug.Log("Start" + (playerController - 1) + " Button!");
			}
			...
			if(Input.GetButton(gamepad[playerController, 2]))//Gets the X button
			{
				...
				//Debug.Log("X" + (playerController - 1) + " Button!");
				
			}

			if(Input.GetButton(gamepad[playerController, 3]))//Gets the Y button
			{
				//Debug.Log("Y" + (playerController - 1) + " Button!");
			}
		}
	}
