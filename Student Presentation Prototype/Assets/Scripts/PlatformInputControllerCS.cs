...
public class PlatformInputControllerCS : MonoBehaviour
{
	...
	public Xbox360_Controls playerNumber;
    ...
    void Update()
    {
		...
		Vector3 directionVector = new Vector3(Input.GetAxis("p" + playerNumber.playerController + "horizontal"), Input.GetAxis("p" + playerNumber.playerController + "vertical"), 0);
        ...
        if (directionVector != Vector3.zero)
        {
			...
			playerNumber.playerAnimator.SetFloat("Speed", 1.0f);
        }
		else
		{
			playerNumber.playerAnimator.SetFloat("Speed", 0.0f);
		}
		...
		motor.inputJump = Input.GetButton("p" + playerNumber.playerController + "action");
