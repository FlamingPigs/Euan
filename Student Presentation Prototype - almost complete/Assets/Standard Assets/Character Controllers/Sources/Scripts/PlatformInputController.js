...
function Update () {
	...
	var directionVector = new Vector3(Input.GetAxis("p" + playerNumber + "horizontal"), Input.GetAxis("p" + playerNumber + "vertical"), 0);
	...
	motor.inputJump = Input.GetButton("p" + playerNumber + "action");
